select s.student_id,
    ...
    s.n_weighted,
    s.n_unweighted,
    s.avg_score_weighted,
    s.avg_score_unweighted,
    s.avg_score_combined,
    s.submitted_ratio_combined_weighted,
    s.submitted_ratio_combined_unweighted,
    s.submitted_ratio_combined,
    m.n n_total,
...
from agg.assessment_score_calcs s
    join agg.mom_assessments_1234 m on m.student_id = s.student_id